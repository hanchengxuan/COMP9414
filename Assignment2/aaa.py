...
sequence_number_train, sequence_number_test, comment_train, comment_test, rating_train, rating_test = \
    train_test_split(sequence_number, comment, rating_sentiments, test_size=0.2, random_state=10, shuffle=False)
...
# ps_processed_comment_train = [ps.stem(word) for word in processed_comment_train]
# ps_processed_comment_test = [ps.stem(word) for word in processed_comment_test]
token = r'[a-zA-Z0-9$%/-]{2,}'
...
# print("----dt")
# min_value = int(len(comment_train)//100)
